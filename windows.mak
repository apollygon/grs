...
all : soferox-2.16.3-win32.msi soferox-2.16.3-win64.msi
...
x86_R_St\soferox-qt.exe : src\soferox.cpp src\qt\res_bitcoin.cpp
	""$(MSB)"" soferox.sln /p:Configuration=R_St,Platform=x86 /v:n

x64_R_St\soferox-qt.exe : src\soferox.cpp src\qt\res_bitcoin.cpp
	""$(MSB)"" soferox.sln /p:Configuration=R_St,Platform=x64 /v:n


soferox-2.16.3-win32.msi : soferox.wxs x86_R_St\soferox-qt.exe
	candle.exe -o soferox-x86.wixobj soferox.wxs
	$(WIX_LINK)  -out $@ soferox-x86.wixobj

soferox-2.16.3-win64.msi : soferox.wxs x64_R_St\soferox-qt.exe
