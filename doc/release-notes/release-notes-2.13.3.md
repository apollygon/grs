...
Then, to tunnel a SSL connection on 25332 to a RPC server bound on localhost on port 15332 do:

    stunnel -d 25332 -r 127.0.0.1:15332 -p stunnel.pem -P ''
...
- **Increased security for multisig:** Soferox addresses (both P2PKH addresses
  ...
  Segwit allows advanced transactions to use the Soferox hash function instead,
